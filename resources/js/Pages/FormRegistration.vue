...
const sendWhatsAppMessageArray = (phoneNumber, card_number) => {
    ...
    const textMessage = 
        'اهلاً وسهلاً بك..' + '\n\n' +
        'نشكر انضمامك لأسرة مستشفى الشرق الأوسط بالتعاون مع الجامعة الفرنسية ، ونود إعلامك بأنه تم تنشيط بطاقتك الصحية وباستطاعتك الاستفادة من كافة خدمات البطاقة انتمنى لك تجربة سعيدة وصحة جيدة.' + '\n\n' +
