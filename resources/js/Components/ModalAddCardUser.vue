        ...
        <div class="modal-wrapper ">
          <div class="modal-container">
            ...
            <div class="modal-body">
                        ...
                        <div className="mb-4 mx-5">
                          ...
                          <select
                            ...
                            <option v-for="(card, index) in data" :key="index" :value="card.id">{{ card.name }}</option>
                          </select>
                        </div>
                        <div className="mb-4 mx-5">
                        <label for="card" >عدد البطاقة التي تم تسليمها للمندوب</label>
                        <input
                          id="card"
                          type="number"
            ...
            <div class="modal-footer my-2">
              ...
              <div class="basis-1/2 px-4">
                <button class="modal-default-button py-3  bg-rose-500 rounded col-6"  @click="$emit('a',form);" :disabled="!(form.card && form.card_id)">نعم</button>
                </div>
