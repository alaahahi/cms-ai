...
<template>
  ...
  <AuthenticatedLayout>
    ...
    >
      <template #header>
        <h3 class="text-center fw-10">هل انت متأكد من قبول نتائج التحاليل</h3>
      </template>
    </ModaSave>
    <ModaSave
    ...
    >
      <template #header>
        <h3 class="text-center fw-10 text-red-500">
              ...
              <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                  ...
                  <div className="flex flex-col  pt-8" style="direction: ltr">
                      ...
                      <div class="basis-1/4">
                        <div className="mb-4 px-3">
                          ...
                          <TextInput
                            ...
                            type="text"
                            class="mt-1 block w-full"
                            :value="profile.husband_hemoglobin_f"
                            disabled
                          />
                        </div>
                      </div>
                      <div class="basis-1/4">
                        <div className="mb-4 px-3">
                          ...
                          <TextInput
                            ...
                            type="text"
                            class="mt-1 block w-full"
                            :value="profile.husband_hemoglobin_a2"
                            disabled
                          />
                        </div>
                      </div>
                    ...
                    <h2 class="text-center text-xl py-8">
                    ...
                    <div class="flex flex-row">
                      <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.husband_talasyma =1">نعم</button>
                          </div>
                          <span
                      ...
                      <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.husband_faqar =1">نعم</button>
                          </div>
                          <span
                    ...
                    <div class="flex flex-row">
                      <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.husband_al =1">نعم</button>
                          </div>
                          <span
                      ...
                      <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.husband_dam =1">نعم</button>
                          </div>
                          <span
                    ...
                    <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.husband_himofilya =1">نعم</button>
                          </div>
                          <span
                  ...
                  <div className="flex flex-col  pt-8" style="direction: ltr">
                      ...
                      <div class="basis-1/4">
                        <div className="mb-4 px-3">
                          ...
                          <TextInput
                            ...
                            :value="profile.wife_hemoglobin_f"
                            disabled
                          />
                        </div>
                      </div>
                      <div class="basis-1/4">
                        <div className="mb-4 px-3">
                          ...
                          <TextInput
                            ...
                            :value="profile.wife_hemoglobin_a2"
                            disabled
                          />
                        </div>
                      </div>
                    ...
                    <div class="flex flex-row">
                      <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.wife_talasyma =1">نعم</button>
                          </div>
                          <span
                      ...
                      <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.wife_faqar =1">نعم</button>
                          </div>
                          <span
                    ...
                    <div class="flex flex-row">
                      <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.wife_al =1">نعم</button>
                          </div>
                          <span
                      ...
                      <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.wife_dam =1">نعم</button>
                          </div>
                          <span
                    ...
                    <div class="basis-1/2">
                        ...
                        >
                          ...
                          <div class="w-full flex justify-center">
                            <button @click.prevent="form.wife_himofilya =1">نعم</button>
                          </div>
                          <span
