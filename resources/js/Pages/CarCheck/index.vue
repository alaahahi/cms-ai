                              ...
                              >
                                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 text-center">
                                  <tr     :class="resultSet.cars.length > 1 
                                    ...
                                    <th scope="col" class="px-3 py-2 sm:px-4 sm:py-2">date</th>
                                    <th scope="col" class="px-3 py-2 sm:px-4 sm:py-2"> car_owner</th>
                                    <th scope="col" class="px-3 py-2 sm:px-4 sm:py-2"> car_type</th>
                                    <th scope="col" class="px-3 py-2 sm:px-4 sm:py-2"> year</th>
                                    <th scope="col" class="px-3 py-2 sm:px-4 sm:py-2"> color</th>
                                    <th scope="col" class="px-3 py-2 sm:px-4 sm:py-2"> vin</th>
                                    <th scope="col" class="px-3 py-2 sm:px-4 sm:py-2"> car_number</th>
                                    <th scope="col" class="px-3 py-2 sm:px-4 sm:py-2"> note</th>
